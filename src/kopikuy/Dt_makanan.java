 ...
 * @author FASIH
 */
public class Dt_makanan extends javax.swing.JFrame {
private koneksi db = new koneksi();
    ...
    public void category(){
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {                
                cmb_category.addItem(rs.getString("name"));
            }
        } catch (Exception e) {
        }
    }
    ...
    public void refresh(){
        txt_no.setText("");
        txt_nama.setText("");
        cmb_category.getModel().setSelectedItem("");
        txt_harga.setText("");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Master / Data Makanan");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO", "KODE", "NAME", "CATEGORY", "HARGA", "QUANTITY"
            }
        ));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cmb_category, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_quantity, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        cmb_category.getModel().setSelectedItem(category);

        String harga = jTable1.getValueAt(baris, 4).toString();
        txt_harga.setText(harga);
        
        String quantity=jTable1.getValueAt(baris, 5).toString();
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if (txt_nama.getText().equals("") && txt_harga.getText().equals("") && txt_quantity.getText().equals("")) {
        ...
        try {
            PreparedStatement ps1 = db.koneksidb().prepareStatement("SELECT * FROM category where name='"+category+"'");
            ResultSet rs1 = ps1.executeQuery();
            rs1.next();
            String categoryID = rs1.getString("categoryID");
            
            String sql = "INSERT INTO foods (name,categoryID,price,food_stock) VALUES ('"+nama+"','"+categoryID+"','"+harga+"','"+qty+"')";
            PreparedStatement ps = db.koneksidb().prepareStatement(sql);
            ps.execute();
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        if (txt_no.getText().equals("")) {
            ...
            try {
                ...
                String sql = "UPDATE foods SET name='"+nama+"',categoryID='"+categoryID+"',price='"+harga+"',food_stock='"+qty+"' WHERE foodID='"+txt_no.getText()+"'";
                PreparedStatement ps = db.koneksidb().prepareStatement(sql);
                ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dt_makanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dt_makanan().setVisible(true);
            }
        });
    }
