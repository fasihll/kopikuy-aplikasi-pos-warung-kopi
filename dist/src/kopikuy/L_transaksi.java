...
int baris;
        ...
        int no_bulan = Integer.parseInt(Bulan.getText())-1;
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                try {
                    ...
                    String path="src/kopikuy/Lap_transaksi.jasper";    // letak file report (dalam format jasper)
    ...
    private void btn_cetak_strukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetak_strukActionPerformed
        ...
        try {
            String path="src/kopikuy/Struk.jasper";    // letak file report (dalam format jasper)
            Map parameter = new HashMap();
