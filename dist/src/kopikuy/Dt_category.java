 ...
 * @author FASIH
 */
public class Dt_category extends javax.swing.JFrame {
private koneksi db = new koneksi();
    ...
    public void table_makanan(String keyword){
        ...
        tbl.addColumn("No");
        tbl.addColumn("ID");
        tbl.addColumn("Nama Category");
        tbl.addColumn("Description");
        jTable1.setModel(tbl);
        try {
            if (keyword != "") {
                String sql = "select * from category where name LIKE '%"+keyword+"%'";  
           ...
           db.koneksidb().close();
            ...
            JOptionPane.showMessageDialog(null, "query table category salah"+e);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Master / Data Category");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String description = jTable1.getValueAt(baris,3).toString();
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if (txt_nama.getText().equals("")) {
            ...
            try {
                String sql = "INSERT INTO category (name,description) VALUES ('"+nama+"','"+description+"')";
                PreparedStatement ps = db.koneksidb().prepareStatement(sql);
                ps.execute();
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        if (opsi == JOptionPane.YES_OPTION) {
            String categoryID = txt_no.getText();
            try {
                String sql = "DELETE FROM category WHERE categoryID='"+txt_no.getText()+"'";
                PreparedStatement ps = db.koneksidb().prepareStatement(sql);
                ps.execute();
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        if (txt_no.getText().equals("")) {
            ...
            try {
                ...
                String sql = "update category set name='"+nama+"',description='"+description+"' where categoryID='"+txt_no.getText()+"'";
                PreparedStatement ps = db.koneksidb().prepareStatement(sql);
                ps.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dt_category.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dt_category().setVisible(true);
            }
        });
    }
